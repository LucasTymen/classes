...
/*
In the example above, we create the Dog class, then create an instance, and
save it to a variable named halley.
...
property or method name. For methods, you must also include opening and closing
parentheses.
